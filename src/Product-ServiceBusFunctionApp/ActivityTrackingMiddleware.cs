...
{
    public static ActivitySource Source = new ActivitySource("reading-from-queue");
    ...
    public async Task Invoke(FunctionContext context, FunctionExecutionDelegate next)
    {
        ...
        {
            activity = Source.StartActivity("Read message Function Executed", ActivityKind.Server);
        }
